        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">チーム管理</h3>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">試合管理</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">リアルタイムスコア</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">検索・発見</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">モバイル対応</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">完全無料</h3>
              <p className="text-gray-600">
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-4">⚾️ 草野球スコア</h3>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/search/games" className="text-gray-400 hover:text-white transition-colors">試合検索</Link></li>
                <li><Link href="/search/teams" className="text-gray-400 hover:text-white transition-colors">チーム検索</Link></li>
                <li><Link href="/login" className="text-gray-400 hover:text-white transition-colors">ログイン</Link></li>
              </ul>
            </div>
            <div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2025 草野球スコア. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
